...
import chap06_class.phone.PhoneInfo2;

public class _07_useOfPhoneInfo {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		PhoneInfo2 phoneInfo2 = new PhoneInfo2();
		...
		while(true) {
			...
			switch(userInput) {
				case 1:
					...
					phoneInfo2.insertPhoneNum(name, phoneNum);
					break;
				case 2:
					phoneInfo2.printAllPhoneNum();
					break;
				case 3:
					while(true) {
						...
						if(index < 1 || index > 100) {
							...
							phoneInfo2.printPhoneNum(index);
							break;
						}
					}
					break;
