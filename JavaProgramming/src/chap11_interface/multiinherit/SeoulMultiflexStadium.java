...
//MultiflexStadium이 Stadium과 ConcertHall의 형태를 가지고 있기 때문에 SeoulMultiflexStadium도 Stadium, ConcertHall의 형태를 가지게 된다.
...
public class SeoulMultiflexStadium implements MultiflexStadium{
	...
	public void getSupportersItem(int people) {
		// TODO Auto-generated method stub
		System.out.println(people + "명의 아이템 구매가격은" + (people * 15000) + "원 입니다.");
	}
	...
	@Override
	public void playSporstsAndConcert() {
		// TODO Auto-generated method stub
